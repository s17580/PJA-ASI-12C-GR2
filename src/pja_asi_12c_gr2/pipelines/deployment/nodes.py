...
def select_best_model(
    ...
    y_train: pd.Series, y_val: pd.Series, y_test: pd.Series, params: Dict[str, Any]
) -> Any:
    ...
    try:
        ...
        autoML_model = train_model(x_train, x_val, y_train, y_val, autoML_params, autoML=True)
        ...
        regular_model = train_model(x_train, x_val, y_train, y_val, regular_params, autoML=False)
